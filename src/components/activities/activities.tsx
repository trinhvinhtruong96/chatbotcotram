				...
				<div className="testimonials">
					<figure className="testimonial">
						...
						<blockquote className="testimonial-text">
							...
							được đồng hành cùng các con trong hành trình khám phá tri thức đầu đời. Ở đây, mỗi ngày đến
							lớp sẽ là một ngày vui – nơi các con được học tập, vui chơi và phát triển toàn diện trong
							tình yêu thương và sự quan tâm của cô.

							Cô mong rằng, cùng với sự phối hợp của quý phụ huynh, chúng ta sẽ tạo nên một môi trường học
					...
					<figure className="testimonial">
						...
						<blockquote className="testimonial-text">
							...
							Cô rất hạnh phúc khi được chào đón các con đến với lớp học nhỏ đầy ắp tiếng cười này. Ở đây,
							các con sẽ được chơi, được học, được làm điều mình thích và cùng nhau trưởng thành mỗi ngày.

							Cô tin rằng, với tình yêu thương và sự quan tâm của cả cô và bố mẹ, các con sẽ có một năm
					...
					<figure className="testimonial">
						...
						<blockquote className="testimonial-text">
							...
							Mỗi ngày đến lớp là một hành trình mới – nơi các con được khám phá, sáng tạo và học cách yêu
